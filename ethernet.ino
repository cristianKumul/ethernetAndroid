...
void setup()
{
  ...
  state="<h2 style='color:red'>OFF</h2>";//"OFF";
}
      ...
      if(cliente.available())
      {
        ...
        if(c=='\n' && lineaenblanco)//Si la petición HTTP ha finalizado
        {
          ...
          if(readString.substring(LED,LED+5)=="LED=T")
          {
            ...
            state="<h2 style='color:green'>ON</h2>";//"ON";
          ...
          cliente.println("<title>Sistemas Telemáticos</title>");
          cliente.println("</head>");
          cliente.println("<body width=100% height=100%>");
          cliente.println("<center>");
          cliente.println("<h1>Sistemas Telemáticos</h1>");
          cliente.println("<h2>Control de lámpara por Ethernet</h2>");
          cliente.print("<br><br>");
